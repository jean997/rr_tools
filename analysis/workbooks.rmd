...
1. [Conda](https://docs.conda.io/projects/conda/en/latest/) is a package management system (I like Miniconda). For example, suppose I want to make sure that whoever runs my code has a specific version of R and a specific version of python. I can build a conda environment, load that environment and I will be using those specific versions. Then if I need a different version for a different project I can just switch environments. 
